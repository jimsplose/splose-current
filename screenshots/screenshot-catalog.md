...
| Filename | State | Match |
|---|---|---|
| screencapture-acme-splose-patients-5918810-details-2026-03-17-19_29_56.png | Patient details tab | partial — re-audit 2026-04-01: typography PASS (type label 20px/700/green, Details 30px/700/green, General details 18px/700) but layout FAIL — large empty gap in main content area, horizontal tabs duplicating sidebar navigation, content pushed ~630px below nav. "1 Issue" runtime error badge visible. |
...
| Filename | State | Match |
|---|---|---|
| Screenshot 2026-03-11 at 11.16.02 am.png | Invoice view — desktop, Overdue invoice PDF-style with Pay/Email/Actions buttons | partial — re-audit 2026-04-01: section labels 13px/700 PASS (S8 fix working), but invoice # heading 18px/600/rgb(65,69,73) vs prod 30px/700/rgb(66,105,74) FAIL. "Note" sidebar heading 14px/600 vs prod 21px/500 FAIL. |
...
| Filename | State | Match |
|---|---|---|
| Screenshot 2026-03-11 at 11.16.25 am.png | Add payment to invoice — desktop, form with location/date/method/amount | partial — re-audit 2026-04-01: title "Add payment" 30px/700/green PASS (S7 fix working). Labels still FAIL: 14px/400/rgb(110,110,100) vs prod 14px/600/rgb(34,34,34). |
