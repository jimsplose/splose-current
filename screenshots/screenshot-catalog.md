...
| Filename | State | Match |
|---|---|---|
| Screenshot 2026-03-17 at 6.51.37 pm.png | Select a location step — default | partial — sweep 2026-04-17 S31 re-audit. Select btn: prod MINT rgb(209,248,246)/black text/black 1px border/100×40/10px radius vs localhost PURPLE rgb(106,57,228)/white text/no border/74×32/8px. Prod has shifted to mint theming since earlier fix. Continue btn: prod 281×44 full-width/16px/600 vs localhost 92×38/14px/400. Heading color: prod rgb(16,24,40) vs localhost rgb(65,69,73) (size 36px/600 matches). Location card radius: prod 0px vs localhost 16px. Tasks label: prod 18px/500 stacked above subtitle vs localhost 14px/600 inline. Book Now banner: prod 1240×49 vs localhost 672×40. BG: prod pale peach tint vs localhost white. Location image: prod horse 100×100 vs localhost fire emoji placeholder. |
