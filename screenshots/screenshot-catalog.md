...
| Filename | State | Match |
|---|---|---|
| screencapture-acme-splose-settings-integrations-2026-03-17-18_34_17.png | Integrations list default | partial — sweep 2026-04-16: major improvement from NO. Xero logo 100x100 exact match, Connect button white/outlined (bg white, border 1px solid rgb(65,69,73), 8px radius) exact match, card layout 3-column grid matches. QuickBooks logo aspect ratio differs (prod 313x80, localhost 204x100). Brand purple links present. Remaining: heading font deep measurement needed, connected states. |
...
| Filename | State | Match |
|---|---|---|
| screencapture-acme-splose-patients-5918810-details-2026-03-17-19_29_56.png | Patient details tab | yes — fidelity fix 2026-04-01: layout restructured — heading full-width above sidebar+content row, horizontal tabs removed. Measurement-verified: type label 20px/700/green, Details 30px/700/green, sidebar active rgb(0,0,0). |
...
| Filename | State | Match |
|---|---|---|
| Screenshot 2026-03-11 at 11.16.02 am.png | Invoice view — desktop, Overdue invoice PDF-style with Pay/Email/Actions buttons | yes — fidelity fix 2026-04-01: invoice # heading now 30px/700/rgb(66,105,74) PASS. Note heading now 21px/500/rgb(65,69,73) PASS. Section labels 13px/700 PASS. |
