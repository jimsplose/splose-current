...
async function main() {
  ...
  // Create clients (12 total)
  const clients = await Promise.all([
    prisma.client.create({
      data: { firstName: "Michael", lastName: "Brooks", email: "michael.brooks@email.com", phone: "0401 111 222", dateOfBirth: "1985-03-15", address: "42 Park Avenue, Melbourne VIC 3000", medicare: "2345 67890 1" },
    }),
    prisma.client.create({
      data: { firstName: "Lisa", lastName: "Martinez", email: "lisa.martinez@email.com", phone: "0402 222 333", dateOfBirth: "1992-07-22", address: "15 Ocean Drive, St Kilda VIC 3182", ndisNumber: "431234567" },
    }),
    prisma.client.create({
      data: { firstName: "Tom", lastName: "Nguyen", email: "tom.nguyen@email.com", phone: "0403 333 444", dateOfBirth: "1978-11-08", address: "88 Collins Street, Melbourne VIC 3000", medicare: "3456 78901 2" },
    }),
    prisma.client.create({
      data: { firstName: "Sophie", lastName: "Anderson", email: "sophie.anderson@email.com", phone: "0404 444 555", dateOfBirth: "2018-02-14", address: "7 Elm Court, Richmond VIC 3121", ndisNumber: "431987654" },
    }),
    prisma.client.create({
      data: { firstName: "David", lastName: "Park", email: "david.park@email.com", phone: "0405 555 666", dateOfBirth: "1965-09-30", address: "120 High Street, Prahran VIC 3181", medicare: "4567 89012 3" },
    }),
    prisma.client.create({
      data: { firstName: "Jenny", lastName: "Jenkins", email: "jenny.j@email.com", phone: "0406 666 777", dateOfBirth: "2002-02-02", address: "55 King William St, Adelaide SA 5000", medicare: "5678 90123 4" },
    }),
    prisma.client.create({
      data: { firstName: "Harry", lastName: "James", email: "harry.james@email.com", phone: "0407 777 888", dateOfBirth: "1985-07-05", address: "8 Rundle Mall, Adelaide SA 5000", ndisNumber: "432345678" },
    }),
    prisma.client.create({
      data: { firstName: "Ella", lastName: "Thompson", email: "ella.t@email.com", phone: "0408 888 999", dateOfBirth: "2015-02-18", address: "22 Henley Beach Rd, Adelaide SA 5000", ndisNumber: "432456789" },
    }),
    prisma.client.create({
      data: { firstName: "Oliver", lastName: "Wilson", email: "oliver.w@email.com", phone: "0409 999 000", dateOfBirth: "1990-04-12", address: "15 Morphett St, Adelaide SA 5000", medicare: "6789 01234 5" },
    }),
    prisma.client.create({
      data: { firstName: "Charlotte", lastName: "Brown", email: "charlotte.b@email.com", phone: "0410 000 111", dateOfBirth: "1975-12-25", address: "30 Hutt St, Adelaide SA 5000" },
    }),
    prisma.client.create({
      data: { firstName: "William", lastName: "Taylor", email: "william.t@email.com", phone: "0411 111 222", dateOfBirth: "2010-08-19", address: "44 Prospect Rd, Adelaide SA 5000", ndisNumber: "432567890" },
    }),
    prisma.client.create({
      data: { firstName: "Amelia", lastName: "Davis", email: "amelia.d@email.com", phone: "0412 222 333", dateOfBirth: "1998-06-30", address: "12 The Parade, Adelaide SA 5000", medicare: "7890 12345 6" },
    }),
  ]);
