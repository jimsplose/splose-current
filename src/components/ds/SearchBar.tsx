  ...
  return (
    <div className="mb-4 flex items-center gap-2">
      <input
        ...
        className="h-[38px] flex-1 rounded-lg border border-[rgb(217,217,217)] bg-white px-[11px] text-[16px] outline-none focus:border-primary focus:ring-1 focus:ring-primary/20"
      />
      <button
