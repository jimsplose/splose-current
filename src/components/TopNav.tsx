...
/* Ant Design outlined icons — SVG paths extracted from production (acme.splose.com) */
const iconProps = { viewBox: "64 64 896 896", width: "1em", height: "1em", fill: "currentColor", "aria-hidden": true as const };
