        ...
        >
          <div className="w-full max-w-lg rounded-xl bg-white shadow-xl">
            ...
            <div className="space-y-4 px-6 py-5">
              ...
              {/* Practitioner */}
              <div>
                <label className="block text-sm font-medium text-text-secondary mb-1">Practitioner *</label>
                <select
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full rounded-lg border border-border bg-white px-3 py-2 text-sm text-text outline-none focus:border-primary focus:ring-1 focus:ring-primary/20 resize-none"
                />
              </div>
            </div>
