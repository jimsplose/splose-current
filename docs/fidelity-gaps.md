...
- [ ] **Settings Integrations page** — REOPENED 2026-04-14: headings/card-border/grid match, but 12 measurement failures remain: (1) logos 48px height vs prod 100px, (2) Connect buttons purple-filled vs prod white/outlined, (3) missing brand-name links in descriptions, (4) card bg transparent vs prod white, (5) Disconnect red rgb(208,0,50) vs prod rgb(240,0,50), (6) desc fontSize 14px vs prod 15px. Fix in `src/app/settings/integrations/page.tsx`.
