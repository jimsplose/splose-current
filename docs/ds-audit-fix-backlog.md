...
| 21 | in-progress | **HintIcon: `tone="inverted"` + `size`** | Add `tone` + `size` props to HintIcon. Migrate ClientDetailClient:285, 286, 291. Storybook. | 10 min | 04 | Sonnet | none | `HintIcon` |
