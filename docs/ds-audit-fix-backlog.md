...
|---|---|---|---|---|---|---|
| 01 | done | **Text: add `weight` prop** | Add `weight?: "regular" \| "medium" \| "bold"` to `Text`. Update CSS module to apply weight when prop set. Migrate 8+ InvoiceDetailClient callers and 10+ invoices/[id]/page.tsx callers as part of same session. Storybook: add Weight story to Text.stories. | 2h | Sonnet | `Text` |
